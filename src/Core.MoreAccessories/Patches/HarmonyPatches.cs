...
namespace MoreAccessoriesKOI
{
    ...
    internal static class CustomAcsChangeSlot_Start_Patches
    {
        private static void Postfix(CustomAcsChangeSlot __instance)
        {
            ...
            MoreAccessories._self._customAcsParentWin = __instance.customAcsParentWin;
            MoreAccessories._self._customAcsMoveWin = __instance.customAcsMoveWin;
            MoreAccessories._self._customAcsSelectKind = __instance.customAcsSelectKind;
    ...
    internal static class CustomAcsParentWindow_ChangeSlot_Patches
    {
        ...
        {
            Toggle tglReference = __instance.tglReference;
    ...
    internal static class CustomAcsMoveWindow_Start_Patches
    {
        private static bool Prefix(CustomAcsMoveWindow __instance)
        {
            ...
            Button btnClose = __instance.btnClose;
            if (btnClose)
            {
            ...
            }).ToList().ForEach(p =>
            {
                p.btn.OnClickAsObservable().Subscribe(delegate
                {
                    if (!change)
                    {
                        ...
                        (__instance.inpPos)[num].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 0][num].ToString();
            ...
            }).ToList().ForEach(p =>
            {
                p.btn.OnClickAsObservable().Subscribe(delegate
                {
                    if (!change)
                    {
                        ...
                        if (MoreAccessories._self._hasDarkness == false)
                            MoreAccessories._self.GetCvsAccessory(__instance.nSlotNo).UpdateAcsMoveHistory();
                        (__instance.inpRot)[num].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 1][num].ToString();
                        MoreAccessories._self.GetCvsAccessory(__instance.nSlotNo).SetControllerTransform(__instance.correctNo);
                    }
                });
                p.btn.UpdateAsObservable().SkipUntil(p.btn.OnPointerDownAsObservable().Do(delegate
            ...
            }).ToList().ForEach(p =>
            {
                p.btn.OnClickAsObservable().Subscribe(delegate
                {
                    if (!change)
                    {
                        ...
                        if (MoreAccessories._self._hasDarkness == false)
                            MoreAccessories._self.GetCvsAccessory(__instance.nSlotNo).UpdateAcsMoveHistory();
                        (__instance.inpScl)[num].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 2][num].ToString();
                    }
                });
                p.btn.UpdateAsObservable().SkipUntil(p.btn.OnPointerDownAsObservable().Do(delegate
                {
            ...
            (__instance.btnPaste).OnClickAsObservable().Subscribe(delegate
            {
                ...
                if (MoreAccessories._self._hasDarkness == false)
                    MoreAccessories._self.GetCvsAccessory(__instance.nSlotNo).UpdateAcsMoveHistory();
                (__instance.inpPos)[0].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 0].x.ToString();
                (__instance.inpPos)[1].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 0].y.ToString();
                (__instance.inpPos)[2].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 0].z.ToString();
                (__instance.inpRot)[0].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 1].x.ToString();
                (__instance.inpRot)[1].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 1].y.ToString();
                (__instance.inpRot)[2].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 1].z.ToString();
                (__instance.inpScl)[0].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 2].x.ToString();
                (__instance.inpScl)[1].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 2].y.ToString();
                (__instance.inpScl)[2].text = MoreAccessories._self.GetPart(__instance.nSlotNo).addMove[__instance.correctNo, 2].z.ToString();
                MoreAccessories._self.GetCvsAccessory(__instance.nSlotNo).SetControllerTransform(__instance.correctNo);
            });
    ...
    internal static class CustomAcsSelectKind_OnSelect_Patches
    {
        ...
        {
            CustomSelectInfo selectInfoFromIndex = __instance.listCtrl.GetSelectInfoFromIndex(index);
